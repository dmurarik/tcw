...
import edu.tcw.libraryresources.data.Content.ResourceItem;

/**
 * A list fragment representing a list of Resouces. This fragment
...
public class ResourceListFragment extends ListFragment {
    ...
    private class CustomAdapter extends BaseAdapter{
		...
		public ResourceItem getItem(int position) {
			// TODO Auto-generated method stub
			return Content.ITEMS.get(position);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            LayoutInflater inflater = ResourceListFragment.this.getActivity().getLayoutInflater();
            View row;
            ...
            if(item.mImageResource != -1)
            	image.setImageResource(item.mImageResource);
          	title.setText(item.mName);
			return row;
		}
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(Content.ITEMS.get(position).mId);
    }
