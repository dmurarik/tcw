...
public class ResourceDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Content.ITEM_MAP.get(getIntent().getStringExtra(ResourceDetailFragment.ARG_ITEM_ID)).mName);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == 1423){
        	String url = Content.ITEM_MAP.get(getIntent().getStringExtra(ResourceDetailFragment.ARG_ITEM_ID)).mUrl;
